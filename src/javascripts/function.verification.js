...
function getNomClasse(Niveau1, Niveau2, idPersonnel) {
	switch(Niveau1) {
		...
		case "4e" :
	 	case "3e" :
	 		var Enseignant = getValues("DISTINCT Nom, Prenom", "Personnel", "WHERE idPersonnel = '"+idPersonnel+"'");
			Niveau1 = Niveau1.substring(0,1) + Enseignant[0]["Prenom"].substring(0,1) + Enseignant[0]["Nom"].substring(0,1);
	 		break;
		default:
			Niveau = "";
			break;
