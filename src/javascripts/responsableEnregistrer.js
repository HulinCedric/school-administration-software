...
function matchResponsableField() {
	...
	arr.push(" idResponsableLegal = '"
			+ document.getElementById("idResponsableLegal").value + "' ");
...
function responsableEnregistrer() {
	...
	if (document.getElementById("ResponsableNom").value == "") {
		...
		erreur = erreur + "<p>Le nom est vide</p>";
			...
			.getElementById("ResponsableNom").value)) {
		document.getElementById("ResponsableNom").className = "invalid";
		ok = false;
		erreur = erreur + "<p>Le nom n'est pas alphabétique</p>";
	} else
		document.getElementById("ResponsableNom").className = "valid";
	...
	if (document.getElementById("ResponsablePrenom").value == "") {
		...
		erreur = erreur + "<p>Le prénom est vide</p>";
			...
			.getElementById("ResponsablePrenom").value)) {
		document.getElementById("ResponsablePrenom").className = "invalid";
		ok = false;
		erreur = erreur + "<p>Le prénom n'est pas alphabétique</p>";
	} else
		document.getElementById("ResponsablePrenom").className = "valid";
	...
	if (document.getElementById("idResponsableLegal").value == "")
		if (ok)
			if (file(
					...
					"Request=SELECT idResponsableLegal FROM ResponsableLegal WHERE Nom='"
	...
	if (document.getElementById("ResponsableNomUsage").value == "") {
		document.getElementById("ResponsableNomUsage").className = "valid";
			...
			.getElementById("ResponsableNomUsage").value)) {
	...
	if (document.getElementById("ResponsableVoie").value == "") {
		...
		document.getElementById("ResponsableVoie").className = "valid";
	...
	if (document.getElementById("ResponsableCodePostal").value == "") {
		...
		erreur = erreur + "<p>Le code postal de l'adresse est vide</p>";
			...
			.getElementById("ResponsableCodePostal").value)) {
		document.getElementById("ResponsableCodePostal").className = "invalid";
		ok = false;
		erreur = erreur
				+ "<p>Le code postal de l'adresse n'est pas correct</p>";
	} else
		document.getElementById("ResponsableCodePostal").className = "valid";
	...
	if (document.getElementById("ResponsableCommune").value == "") {
		...
		erreur = erreur + "<p>La commune de l'adresse est vide</p>";
			...
			.getElementById("ResponsableCommune").value)) {
		document.getElementById("ResponsableCommune").className = "invalid";
		ok = false;
		erreur = erreur + "<p>La commune de l'adresse n'est pas correct</p>";
	} else
		document.getElementById("ResponsableCommune").className = "valid";
	...
	if (document.getElementById("ResponsablePays").value == "") {
		...
		erreur = erreur + "<p>Le pays de l'adresse est vide</p>";
			...
			.getElementById("ResponsablePays").value)) {
		document.getElementById("ResponsablePays").className = "invalid";
		ok = false;
		erreur = erreur + "<p>Le pays de l'adresse n'est pas correct</p>";
	} else
		document.getElementById("ResponsablePays").className = "valid";
	...
	if (document.getElementById("ResponsableTelephone").value == "")
		document.getElementById("ResponsableTelephone").className = "valid";
			...
			.getElementById("ResponsableTelephone").value)) {
	...
	else if (!verifcationMail(document.getElementById("ResponsableMail").value)) {
	...
	if (document.getElementById("ResponsableTelephoneProfessionnel").value == "")
		document.getElementById("ResponsableTelephoneProfessionnel").className = "valid";
			...
			.getElementById("ResponsableTelephoneProfessionnel").value)) {
		document.getElementById("ResponsableTelephoneProfessionnel").className = "invalid";
		ok = false;
		erreur = erreur
				+ "<p>Le numéro de téléphone professionnel n'est pas correct</p>";
	} else
		document.getElementById("ResponsableTelephoneProfessionnel").className = "valid";
	...
	if (document.getElementById("ResponsableTelephonePortable").value == "")
		document.getElementById("ResponsableTelephonePortable").className = "valid";
			...
			.getElementById("ResponsableTelephonePortable").value)) {
	...
	if (ok) {
		...
		var Adresse = file("phpscripts/adresseEnregistrer.php", "Voie="
				+ document.getElementById("ResponsableVoie").value
				+ "&CodePostal="
				+ document.getElementById("ResponsableCodePostal").value
				+ "&Commune="
				+ document.getElementById("ResponsableCommune").value
				+ "&Pays=" + document.getElementById("ResponsablePays").value
				+ "&Telephone="
				+ document.getElementById("ResponsableTelephone").value);

		if (document.getElementById("idResponsableLegal").value == "")
			file(
					"phpscripts/DBExecuteQuery.php",
					"Request=INSERT INTO "
							+ "ResponsableLegal (Civilite, Nom, NomUsage, Prenom, Adresse, Profession, TelephoneProfessionnel, TelephonePortable, Mail) "
							+ "VALUES ("
							...
							+ ","
							+ nullableValueInsert(document
									.getElementById("ResponsableProfession").value)
							+ ","
							+ nullableValueInsert(document
									.getElementById("ResponsableTelephoneProfessionnel").value)
							+ ","
							...
							+ ","
							+ nullableValueInsert(document
									.getElementById("ResponsableMail").value)
							+ ");");
		else
			file(
					"phpscripts/DBExecuteQuery.php",
					"Request=UPDATE "
							...
							+ nullableValueUpdate(
									"idResponsableLegal",
									document
											.getElementById("idResponsableLegal").value)
							+ ";");
