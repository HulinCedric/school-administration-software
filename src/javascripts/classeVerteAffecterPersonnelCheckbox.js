...
function personnelListerJQuery() {
	...
	arr
			.push(" P1.idPersonnel NOT IN ( Select P.idPersonnel From Personnel as P, Accompagnateur AS A Where P.DateRadiation IS NULL And P.idPersonnel = A.Personnel And A.DateDebut = '"
	...
	var data = getValues("DISTINCT P1.*", "Personnel as P1",
			constrainGenerator(arr) + " ORDER BY P1.Nom ");
