...
function matchClasseVerteField() {
	...
	matchDataField("AccompagnateursAutres", ClasseVerte[0]["AccompagnateursAutres"]);
}
...
function classeVerteEnregistrer() {
	...
	var erreur = "";	
  	...
  	// Lieu
	//
	document.getElementById("Lieu").value = document.getElementById("Lieu").value.capitalize();
  	...
  	else document.getElementById("Lieu").className = "valid";
	...
	else document.getElementById("DateDebut").className = "valid";
	...
	else document.getElementById("DateFin").className = "valid";
	...
	//
  	...
  	if(!verifcationNumeric(document.getElementById("PrixComptable").value)) {
 		document.getElementById("PrixComptable").className = "invalid";
 		ok = false;
		erreur = erreur + "<p>Le prix agent comptable n'est pas numérique</p>";
  	}
  	else document.getElementById("PrixComptable").className = "valid";
	...
	//
  	...
  	if(!verifcationNumeric(document.getElementById("PrixAssociation").value)) {
 		document.getElementById("PrixAssociation").className = "invalid";
 		ok = false;
		erreur = erreur + "<p>Le prix association n'est pas numérique</p>";
  	}
  	else document.getElementById("PrixAssociation").className = "valid";
	...
	//
  	...
  	if(!verifcationNumeric(document.getElementById("AideAssociation").value)) {
 		document.getElementById("AideAssociation").className = "invalid";
 		ok = false;
		erreur = erreur + "<p>Le prix d'aide association n'est pas numérique</p>";
  	}
  	else document.getElementById("AideAssociation").className = "valid";
  	...
  	if (document.getElementById("LieuModifier").value == "")
  		if (ok)
   			if(file("phpscripts/DBCountResultQuery.php",
  					"Request=SELECT * FROM ClasseVerte WHERE Lieu='" + document.getElementById("Lieu").value +
  					"' AND DateDebut ='" + dateReverse(document.getElementById("DateDebut").value) + "'")!=0) {
				document.getElementById("Lieu").className = "invalid";
				document.getElementById("DateDebut").className = "invalid";
				ok = false;
    ...
    if (ok) {
		...
		if (LieuModifier == "")
			file("phpscripts/DBExecuteQuery.php", 
				...
				"VALUES ("+
					nullableValueInsert(document.getElementById("Lieu").value)+","+
					nullableValueInsert(dateReverse(document.getElementById("DateDebut").value))+","+
					nullableValueInsert(dateReverse(document.getElementById("DateFin").value))+","+
					nullableValueInsert(document.getElementById("PrixComptable").value)+","+
					nullableValueInsert(document.getElementById("PrixAssociation").value)+","+
					nullableValueInsert(document.getElementById("AideAssociation").value)+","+
					nullableValueInsert(document.getElementById("AccompagnateursAutres").value)+
				")"
			);
		else {
			file("phpscripts/DBExecuteQuery.php",
				"Request=UPDATE "+
					"ClasseVerte "+
				"SET "+
					nullableValueUpdate("Lieu", document.getElementById("Lieu").value)+","+
					nullableValueUpdate("DateDebut", dateReverse(document.getElementById("DateDebut").value))+","+
					nullableValueUpdate("DateFin", dateReverse(document.getElementById("DateFin").value))+","+
					nullableValueUpdate("PrixComptable", document.getElementById("PrixComptable").value)+","+
					nullableValueUpdate("PrixAssociation", document.getElementById("PrixAssociation").value)+","+
					nullableValueUpdate("AideAssociation", document.getElementById("AideAssociation").value)+","+
					nullableValueUpdate("AccompagnateursAutres", document.getElementById("AccompagnateursAutres").value)+
				" WHERE "+
