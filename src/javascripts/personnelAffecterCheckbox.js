...
function personnelListerJQuery() {
	...
	arr
			.push(" P1.idPersonnel NOT IN ( Select P.idPersonnel From Personnel as P, AffectationCharge AS AC Where P.DateRadiation IS NULL And P.idPersonnel = AC.Enseignant And AC.Annee = '"
...
function personnelAffecter() {
	...
	// Charge
	//
	document.getElementById("Charge").value = document.getElementById("Charge").value
			.capitalize();
	if (document.getElementById("Charge").value == "") {
		...
		document.getElementById("Charge").className = "valid";
