...
function matchEnfantField() {
	...
	matchDataField("DateDemandeInscription", dateReverse(Enfant[0]["DateDemandeInscription"]));
...
function enfantEnregistrer() {
  	...
  	if (document.getElementById("idEnfant").value == "")
  		if (ok)
   			if(file("phpscripts/DBCountResultQuery.php",
  					"Request=SELECT idEnfant FROM Enfant WHERE Nom='" + document.getElementById("Nom").value +
  					"' AND Prenom='" + document.getElementById("Prenom").value + "'")!=0) {
				document.getElementById("Nom").className = "invalid";
				document.getElementById("Prenom").className = "invalid";
				ok = false;
	...
	if(document.getElementById("Niveau").value == "") {
 		...
 		ok = false;
		erreur = erreur + "<p>Veuillez renseigner le niveau scolaire de l'enfant</p>";
  	}
    ...
    if (ok) {
		...
		if (idEnfant == "") {
		idEnfant = file("phpscripts/DBIdResultExecuteQuery.php", 
				"Request=INSERT INTO "+
				...
				"VALUES ("+
					"NULL,"+
					nullableValueInsert(document.getElementById("INE").value)+","+
					nullableValueInsert(document.getElementById("RegistreMatricule").value)+","+
					nullableValueInsert(dateReverse(document.getElementById("DateDemandeInscription").value))+","+
					
					nullableValueInsert(Sexe)+","+
					nullableValueInsert(document.getElementById("Nom").value)+","+
					nullableValueInsert(document.getElementById("NomUsage").value)+","+
					nullableValueInsert(document.getElementById("Prenom").value)+","+
					nullableValueInsert(dateReverse(document.getElementById("DateNaissance").value))+","+
					nullableValueInsert(document.getElementById("Nationalite").value)+","+
					
					nullableValueInsert(document.getElementById("CommuneNaissance").value)+","+
					nullableValueInsert(document.getElementById("DepartementNaissance").value)+","+
					nullableValueInsert(document.getElementById("PaysNaissance").value)+","+

					nullableValueInsert(document.getElementById("Niveau").value)+","+
					nullableValueInsert(Sieste)+","+
					nullableValueInsert(document.getElementById("LangueVivante1").value)+","+
					nullableValueInsert(document.getElementById("LangueVivante2").value)+","+
					...
					nullableValueInsert(document.getElementById("CompagnieAssurance").value)+","+
					nullableValueInsert(document.getElementById("NumeroPoliceAssurance").value)+","+
		...
		file(	"phpscripts/DBExecuteQuery.php",
			...
			file(	"phpscripts/DBExecuteQuery.php",
				...
				"SET "+
					...
					nullableValueUpdate("Niveau", document.getElementById("Niveau").value)+","+
					nullableValueUpdate("DateDemandeInscription", dateReverse(document.getElementById("DateDemandeInscription").value))+","+
					nullableValueUpdate("DecisionCommission", DecisionCommission)+","+
					nullableValueUpdate("ConfirmationParents", ConfirmationParents)+","+
