autoComplete("#Nom", "Nom", "Enfant, Scolariteinterne",
		"WHERE DateEntreeEcole IS NULL AND idEnfant = Enfant");
autoCompleteSelectSimple("Promotion", "Promotion", "Scolariteinterne",
		"WHERE DateEntreeEcole IS NULL ORDER BY Promotion DESC");
...
function printEnfant() {
	...
	window
			.open("phpscripts/DBRequestValuesExcel.php?Filename="
					+ libelle
					+ "&Request=Select E.INE, E.RegistreMatricule, E.DatePremiereDemande, E.Sexe, E.DateNaissance, E.Nationalite, E.CommuneNaissance, E.DepartementNaissance, E.PaysNaissance, E.Niveau, E.LangueVivante1, E.LangueVivante2, E.Sieste, E.Regime, E.Boursier, E.ResponsabiliteCivile, E.IndividuelleAccident, E.CompagnieAssurance, E.NumeroPoliceAssurance, E.AttestationFournie, E.GarderieMatin, E.GarderieSoir, E.DiffusionAdresseAssociation, E.PAI, E.MDPH, SI.Promotion, SI.DateDemandeInscription, SI.DecisionCommission, SI.ConfirmationParents, SI.AutorisationSortie, ARL.Statut, ARL.AutoriteParentale, ARL.AdressePrincipale, RL.Civilite, RL.Nom as NomRL, RL.NomUsage as NomUsageRL, RL.Prenom as PrenomRL, RL.Profession, RL.TelephoneProfessionnel, RL.TelephonePortable, RL.Mail, A.Voie, A.CodePostal, A.Commune, A.Pays, A.Telephone From Enfant AS E, Scolariteinterne AS SI, ResponsableLegal AS RL, AssociationResponsableLegal AS ARL, Adresse AS A "
					+ constrainGenerator(arr));
}
...
function printAllEnfant() {
	...
	window
			.open("phpscripts/DBRequestValuesExcel.php?Filename=Enfants - "
					+ document.getElementById("Promotion").value
					+ "&Request=Select E.Nom, E.NomUsage, E.Prenom, E.INE, E.RegistreMatricule, E.DatePremiereDemande, E.Sexe, E.DateNaissance, E.Nationalite, E.CommuneNaissance, E.DepartementNaissance, E.PaysNaissance, E.Niveau, E.LangueVivante1, E.LangueVivante2, E.Sieste, E.Regime, E.Boursier, E.ResponsabiliteCivile, E.IndividuelleAccident, E.CompagnieAssurance, E.NumeroPoliceAssurance, E.AttestationFournie, E.GarderieMatin, E.GarderieSoir, E.DiffusionAdresseAssociation, E.PAI, E.MDPH, SI.Promotion, SI.DateDemandeInscription, SI.DecisionCommission, SI.ConfirmationParents, SI.AutorisationSortie, ARL.Statut, ARL.AutoriteParentale, ARL.AdressePrincipale, RL.Civilite, RL.Nom as NomRL, RL.NomUsage as NomUsageRL, RL.Prenom as PrenomRL, RL.Profession, RL.TelephoneProfessionnel, RL.TelephonePortable, RL.Mail, A.Voie, A.CodePostal, A.Commune, A.Pays, A.Telephone From Enfant AS E, Scolariteinterne AS SI, ResponsableLegal AS RL, AssociationResponsableLegal AS ARL, Adresse AS A "
