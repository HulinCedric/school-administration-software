autoComplete(
		...
		"WHERE DateEntreeEcole IS NULL AND ConfirmationParents = 'Oui' AND idEnfant = Enfant");
autoCompleteSelectSimple(
		"Promotion",
		"Promotion",
		"Scolariteinterne",
		"WHERE DateEntreeEcole IS NULL AND ConfirmationParents = 'Oui' ORDER BY Promotion DESC");
