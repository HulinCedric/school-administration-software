autoComplete(
		...
		"WHERE DateEntreeEcole IS NULL AND ConfirmationParents IS NULL AND DecisionCommission IS NULL AND idEnfant = Enfant");
autoCompleteSelectSimple(
		"Promotion",
		"Promotion",
		"Scolariteinterne",
		"WHERE DateEntreeEcole IS NULL AND ConfirmationParents IS NULL AND DecisionCommission IS NULL ORDER BY Promotion DESC");
