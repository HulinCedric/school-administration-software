...
function matchPersonnelField() {
	...
	for ( var i = 0; i < document.getElementsByName("PersonnelCivilite").length; i++)
...
function personnelEnregistrer() {
	...
	var Civilite = "";
	for ( var i = 0; i < document.getElementsByName("PersonnelCivilite").length; i++)
		if (document.getElementsByName("PersonnelCivilite")[i].checked)
			Civilite = document.getElementsByName("PersonnelCivilite")[i].value;
	if (Civilite == "") {
		ok = false;
	...
	if (document.getElementById("PersonnelNom").value == "") {
		...
		erreur = erreur + "<p>Le nom est vide</p>";
			...
			.getElementById("PersonnelNom").value)) {
		document.getElementById("PersonnelNom").className = "invalid";
		ok = false;
		erreur = erreur + "<p>Le nom n'est pas alphabétique</p>";
	} else
		document.getElementById("PersonnelNom").className = "valid";
	...
	if (document.getElementById("PersonnelPrenom").value == "") {
		...
		erreur = erreur + "<p>Le prénom est vide</p>";
			...
			.getElementById("PersonnelPrenom").value)) {
		document.getElementById("PersonnelPrenom").className = "invalid";
		ok = false;
		erreur = erreur + "<p>Le prénom n'est pas alphabétique</p>";
	} else
		document.getElementById("PersonnelPrenom").className = "valid";
	...
	if (document.getElementById("idPersonnel").value == "")
		if (ok)
			if (file("phpscripts/DBCountResultQuery.php",
					"Request=SELECT idPersonnel FROM Personnel WHERE Nom='"
	...
	if (document.getElementById("PersonnelNomUsage").value == "") {
		document.getElementById("PersonnelNomUsage").className = "valid";
			...
			.getElementById("PersonnelNomUsage").value)) {
	...
	if (document.getElementById("Fonction").value == "") {
		...
		document.getElementById("Fonction").className = "valid";
	...
	if (document.getElementById("PersonnelVoie").value == "") {
		...
		document.getElementById("PersonnelVoie").className = "valid";
	...
	} else if (!verifcationNumeric(document
			.getElementById("PersonnelCodePostal").value)) {
		document.getElementById("PersonnelCodePostal").className = "invalid";
		ok = false;
		erreur = erreur
				+ "<p>Le code postal de l'adresse n'est pas correct</p>";
	} else
		document.getElementById("PersonnelCodePostal").className = "valid";
	...
	if (document.getElementById("PersonnelCommune").value == "") {
		...
		erreur = erreur + "<p>La commune de l'adresse est vide</p>";
			...
			.getElementById("PersonnelCommune").value)) {
		document.getElementById("PersonnelCommune").className = "invalid";
		ok = false;
		erreur = erreur + "<p>La commune de l'adresse n'est pas correct</p>";
	} else
		document.getElementById("PersonnelCommune").className = "valid";
	...
	if (document.getElementById("PersonnelPays").value == "") {
		...
		erreur = erreur + "<p>Le pays de l'adresse est vide</p>";
			...
			.getElementById("PersonnelPays").value)) {
		document.getElementById("PersonnelPays").className = "invalid";
		ok = false;
		erreur = erreur + "<p>Le pays de l'adresse n'est pas correct</p>";
	} else
		document.getElementById("PersonnelPays").className = "valid";
	...
	else if (!verifcationNumeric(document.getElementById("PersonnelTelephone").value)) {
		document.getElementById("PersonnelTelephone").className = "invalid";
		ok = false;
		erreur = erreur
				+ "<p>Le numéro de téléphone portable n'est pas correct</p>";
	} else
		document.getElementById("PersonnelTelephone").className = "valid";
	...
	else if (!verifcationMail(document.getElementById("PersonnelMail").value)) {
	...
	if (document.getElementById("PersonnelTelephonePortable").value == "")
		document.getElementById("PersonnelTelephonePortable").className = "valid";
			...
			.getElementById("PersonnelTelephonePortable").value)) {
	...
	if (ok) {
		...
		//
		var Adresse = file("phpscripts/adresseEnregistrer.php", "Voie="
				+ document.getElementById("PersonnelVoie").value
				+ "&CodePostal="
				+ document.getElementById("PersonnelCodePostal").value
				+ "&Commune="
				+ document.getElementById("PersonnelCommune").value + "&Pays="
				+ document.getElementById("PersonnelPays").value
				+ "&Telephone="
				+ document.getElementById("PersonnelTelephone").value);
		...
		if (document.getElementById("idPersonnel").value == "")
			file(
					...
					"Request=INSERT INTO "
							...
							+ ","
							+ nullableValueInsert(document
									.getElementById("Fonction").value)
							+ ","
							+ nullableValueInsert(document
									.getElementById("PersonnelTelephonePortable").value)
							+ ","
							+ nullableValueInsert(document
									.getElementById("PersonnelMail").value)
							+ ");");
		else
			file(
					"phpscripts/DBExecuteQuery.php",
					"Request=UPDATE "
							...
							+ ", "
							+ nullableValueUpdate("Nom", document
									.getElementById("PersonnelNom").value
									.capitalize())
							+ ", "
							...
							+ ", "
							+ nullableValueUpdate("Fonction", document
									.getElementById("Fonction").value)
							+ ", "
							+ nullableValueUpdate(
									"TelephonePortable",
									document
											.getElementById("PersonnelTelephonePortable").value)
							+ ", "
							+ nullableValueUpdate("Mail", document
									.getElementById("PersonnelMail").value)
							+ "WHERE "
							+ nullableValueUpdate("idPersonnel", document
									.getElementById("idPersonnel").value) + ";");
