autoComplete("#Nom", "Nom", "Enfant, Scolariteinterne", "WHERE DateEntreeEcole IS NULL AND ConfirmationParents IS NULL AND DecisionCommission = 'oui' AND idEnfant = Enfant");
autoCompleteSelectSimple("Promotion", "Promotion", "Scolariteinterne", "WHERE DateEntreeEcole IS NULL AND ConfirmationParents IS NULL AND DecisionCommission = 'oui' ORDER BY Promotion DESC");
