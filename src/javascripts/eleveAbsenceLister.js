...
function enfantListerJQuery() {
	...
	var data = getValues("DISTINCT E.*",
			"Enfant as E, Scolariteinterne as SI, AbscenceScolaire as AC",
...
function enfantAddInformationJQuery() {
	...
	var data = getValues("DISTINCT *", "AbscenceScolaire",
...
function printAbsenceCantine() {
	...
	window
			.open("phpscripts/DBRequestValuesExcel.php?Filename=Absence scolaire - "
					+ libelle
					+ " - "
					+ document.getElementById("Promotion").value
					+ "&Request=Select AC.Date, E.Nom, E.NomUsage, E.Prenom, E.DateNaissance, E.Niveau, E.INE, E.RegistreMatricule, E.Boursier, E.PAI, E.MDPH From AbscenceScolaire AS AC, Enfant AS E"
